...
# Entry variables
     sidebarPanel(h3("Entry variables"),
              ...
              radioButtons("smoker" ," smoker" ,choices = c("0"=0,"1" = 1),""),
              radioButtons("diabetes" ,"diabetes " ,choices = c("0"=0,"1" = 1),""),
              radioButtons("famhist" ,"famhist " ,choices = c("0"=0,"1" = 1),""),
               
   
               
               actionButton("Submit","submit",icon=icon("submit"))
